...
# -----------------------------------------------------------------------------
def augment_ply(row):
    sem_classes = row["semantic_class"]
    positions = row["positions"]  # [x, y, z] in THOR
    orientations = row["rotations"]  # Euler angles [x_deg, y_deg, z_deg] in THOR
    input_idx = row["input_idxs"]
